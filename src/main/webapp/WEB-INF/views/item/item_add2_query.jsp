                            ...
                            <div class="custom-tabs-container">
                                <ul class="fs-6 nav nav-tabs justify-content-center" id="customTab4" role="tablist">
                                    <li class="nav-item" role="presentation" style="border:1px; border-right-style: ridge;">
                                        <a class="nav-link " id="tab-oneAAA" data-bs-toggle="tab" href="#oneAAA" role="tab"
                                           aria-controls="oneAAA" aria-selected="true" ><i class="bi bi-person-badge"></i>HW Details</a>
                                    </li>
                                    <li class="nav-item" role="presentation" style="border:1px; border-right-style: ridge;">
                                        <a class="nav-link active" id="tab-twoAAA" data-bs-toggle="tab" href="#twoAAA" role="tab"
                                ...
                                <div class="tab-content" id="customTabContent">
                                    <div class="tab-pane fade " id="oneAAA" role="tabpanel">
                                                ...
                                                <div class="bib" id="bib">
                                                    <form class="row gx-3 " role="form" action="${contextPath}/hw/item/update" method="post">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <a href="${contextPath}/hw/item/query" class="btn btn-dark float-start">Back</a>
                                                        </div>
                                                        <!-- Form actions end -->
                                                    </form>
                                                </div>
                                    ...
                                    <div class="tab-pane fade show active" id="twoAAA" role="tabpanel">
                                        <div class="row gx-4">
