...
//import com.onsemi.hms.model.HWShipping;
...
public class DoHWListPdf extends AbstractITextPdfViewDoList {

    private static final Logger LOGGER = LoggerFactory.getLogger(DoHWListPdf.class);
...
//        LOGGER.info("masuk pdf...");
        ...
        cellTitle.setPhrase(new Phrase("DO for Hardware from Rel Lab to Sendayan", fontOpenSans(12f, Font.BOLD)));
...
//        List<HWShipping> doList = (List<HWShipping>) model.get("doList");
...
//        cellShipper3.setPhrase(new Phrase("GTS Number : " + doList.get(0).getGtsNo(), fontContent));
        cellShipper3.setPhrase(new Phrase("GTS Number : ", fontContent));
...
//        cellConsignee3.setPhrase(new Phrase("Est. Shipment Date : " + doList.get(0).getShippingDate(), fontContent));
        cellConsignee3.setPhrase(new Phrase("Est. Shipment Date : ", fontContent));
...
//        boxHeader.setPhrase(new Phrase("Total Box : " + doList.size(), fontOpenSans(11f, Font.BOLD)));
        boxHeader.setPhrase(new Phrase("Total Box : ", fontOpenSans(11f, Font.BOLD)));
...
//        doc.add(Chunk.NEWLINE);
        ...
        table.setWidths(new float[]{0.7f, 2.8f, 1.6f, 3.0f, 1.2f, 1.3f});
        table.setSpacingBefore(10);

        Font fontHeader = fontOpenSans(7.0f, Font.BOLD);
...
//                cellHeader.setPhrase(new Phrase("Box Barcode Label", fontHeader));
//                table.addCell(cellHeader);
//                cellHeader.setPhrase(new Phrase("Box ID", fontHeader));
//                table.addCell(cellHeader);
//                cellHeader.setPhrase(new Phrase("Item Description", fontHeader));
//                table.addCell(cellHeader);
...
//            table.addCell(cellContent);
//            cellContent.setPhrase(new Phrase(doList.get(i).getItemCategory() + ": " + doList.get(i).getItemId(), fontContent2));
////            cellContent.setPhrase(new Phrase(doList.get(i).getItemCategory(), fontContent2));
//            table.addCell(cellContent);
//            cellContent.setPhrase(new Phrase(doList.get(i).getWeight(), fontContent2));
//            table.addCell(cellContent);
//            cellContent.setPhrase(new Phrase(doList.get(i).getPrice(), fontContent2));
//            table.addCell(cellContent);
//
//            grandTotalQty = grandTotalQty + 1;
//            grandTotalWeight += Double.parseDouble(doList.get(i).getWeight());
//            grandTotalPrice += Double.parseDouble(doList.get(i).getPrice());
//
//            i++;
//        }
        String jumlahBerat = String.format("%.2f", grandTotalWeight);
        ...
        total.setWidths(new float[]{5.1f, 3.0f, 1.2f, 1.3f});
...
//        cellDriver.setBorder(Rectangle.NO_BORDER);
        ...
        Phrase p = new Phrase("Driver Information", fontOpenSans(9f, Font.BOLDITALIC));
        p.add(Chunk.NEWLINE);
        p.add(Chunk.NEWLINE);
        p.add(Chunk.NEWLINE);
        p.add(new Chunk("Driver Name       : ______________________________________________________________", fontOpenSans(9f, Font.NORMAL)));
        p.add(Chunk.NEWLINE);
        p.add(Chunk.NEWLINE);
        p.add(new Chunk("Driver IC No.       : ______________________________________________________________", fontOpenSans(9f, Font.NORMAL)));
        p.add(Chunk.NEWLINE);
        p.add(Chunk.NEWLINE);
        p.add(new Chunk("Seal No.               : _____________________      Vehicle No. : ________________________ ", fontOpenSans(9f, Font.NORMAL)));
        p.add(Chunk.NEWLINE);
...
//        sign2.setBorder(Rectangle.NO_BORDER);
        ...
        cellTitle2.setPhrase(new Phrase("DO for Hardware from Rel Lab to Sendayan", fontOpenSans(12f, Font.BOLD)));
        ...
        cellTitle3.setPhrase(new Phrase("DO for Hardware from Rel Lab to Sendayan", fontOpenSans(12f, Font.BOLD)));
