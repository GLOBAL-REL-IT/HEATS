    ...
    <s:layout-component name="page_container">
        ...
        <!--                                                     <td><c:out value="${request.Model}"/></td>
                                                       ...
                                                       <td><c:out value="${request.Remarks}"/></td>-->
                                                        <td>
                                                            <!--<button type="button" class="btn btn-primary" href="#" onclick="modalDelete(this);">Detail</button>-->
                                                            <!--<i class="bi bi-box-arrow-in-right h4"></i>-->
<!--                                                            <a modaldeleteid="${request.PKID}" title="Detail" data-toggle="Detail" class="" onclick="modalDelete(this);"> 
                                                                 Detail<i class="bi bi-box-arrow-in-right h3"></i>
                                                            </a>-->
                                                            <a modaldeleteid="${request.PKID}" class="btn btn-sm me-1" title="Detail" data-toggle="Detail" onclick="modalDelete(this);">Detail<i class="bi bi-box-arrow-in-right h3"></i></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="row gx-3">
                                ...
                                <div class="col-xl-2 col-sm-12 col-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <!--<span class="input-group-text"><i class="bi bi-person"></i></span>-->
                                            <input type="text" class="form-control" id="subType" name="subType" placeholder="Enter Full Name" value="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-sm-12 col-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <!--<span class="input-group-text"><i class="bi bi-envelope"></i></span>-->
                                            <input type="text" class="form-control" id="aluHrs" name="aluHrs" placeholder="Enter Email Address" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-sm-12 col-12">
                                ...
                                <!-- Address Section -->
                                <!--                                <div class="col-12 mt-2 mb-3">
                                                                    <h6 class="fw-semibold mb-3 border-start border-success ps-2"
                                                                        style="border-left-width: 3px !important;">
                                                    ...
                                                    function modalDelete(e) {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function (data) {
                                                                ...
                                                                $("#QuarantineQty").val(data.itemType);
                                                                $("#externalCleanQty").val(data.ExternalCleaningQty);
                                                                $("#externalRecleanQty").val(data.ExternalRecleaningQty);
                                                                $("#internalCleanQty").val(data.InternalCleaningQty);
                                                                $("#internalRecleanQty").val(data.InternalRecleaningQty);
