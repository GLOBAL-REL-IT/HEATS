            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-box">
                        ...
                        <form id="add_group_form" class="form-horizontal" role="form" action="${contextPath}/admin/event/save" method="post">
                            <div class="form-group">
                                <label for="groupCode" class="col-lg-3 control-label">Event Code *</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="eventCode" name="eventCode" placeholder="Event Code" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="eventName" class="col-lg-3 control-label">Event Name *</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="eventName" name="eventName" placeholder="Details" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="requirementStatus" class="col-lg-3 control-label">Retention Required? *</label>
                                <div class="col-lg-8">
