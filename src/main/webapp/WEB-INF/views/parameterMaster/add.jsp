                ...
                <div class="col-sm-12 col-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title">Parameter Master - Add</h5>
                        </div>
                        <div class="card-body">
                            <!-- Row start -->
                            <form class="row g-3 align-items-center" role="form" action="${contextPath}/admin/parameterMaster/save" method="post">
                                <div class="row mb-4">
                                    <label class="col-sm-2 col-md-1 col-form-label fw-semibold" for="fName">Code</label>
                                    <div class="col-sm-9 col-md-10">
                                        <div class="row g-2">
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="code" name="code" value="${mastercode}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
