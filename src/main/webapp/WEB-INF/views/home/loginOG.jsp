...
<html lang="en">
    <head>
        ...
        <meta name="description" content="OSPI Storage and Retention Management System (OSTORMS)">
        ...
        <!-- Le favicon -->
        <link rel="shortcut icon" href="${contextPath}/resources/img/inventory.ico">
        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <center style="margin-top: 30px;"><a href="${contextPath}/" style="font-family: 'Lato'; font-size: 22px;">OSPI Storage and Retention Management System (OSTORMS)</a></center>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div id="login-wraper">
                <form action="${contextPath}/" method="post" class="form login-form">
                    <a href="${contextPath}/">
                        <img src="${contextPath}/resources/img/inventory.png" alt="FTC" width="35%" />
                    </a>
                    <legend>Sign in to <span class="blue">OSTORMS</span></legend>
