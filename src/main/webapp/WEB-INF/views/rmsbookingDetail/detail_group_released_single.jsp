                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title d-flex justify-content-between align-items-center">
                                <div>
                                    RMS Released to Production - <span style="color:#D97D55">Detail (${motherboardId})</span>
                                </div>
                                <c:choose>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-xl-2 col-sm-12 col-12">
                                        <div class="mb-1">
                                            ...
                                            <div class="input input-group">
                                                <input type="text" class="form-control" id="loadingDate" name="loadingDate" placeholder="" value="${loadingDate}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-2 col-sm-12 col-12">
                            ...
                            <div class="custom-tabs-container">
                                ...
                                <div class="tab-content" id="customTabContent">
                                    ...
                                    <div class="tab-pane fade ${vmActiveTab}" id="twoAAA" role="tabpanel">
                                        <div class="row gx-4">
                                            <fieldset disabled>
                                                <form class="row gx-3 needs-validation" role="form" action="${contextPath}/rmsbookingDetail/vm/sdsdsdsdsdsd" method="post" enctype="multipart/form-data" novalidate>
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="form-group required col-xl-1 col-sm-12">
                                                                                                        <div class="mb-3">
                                                                                                            <label for="quantity" class="form-label">Quantity</label>
                                                                                                            <div class="input input-group">
                                                                                                                <input type="number" class="form-control" id="totalQty" name="totalQty" value="${testResult.manualQty}" style="width: 100%" required>
                                                                                                                <input type="hidden" class="form-control" id="mibItemId" name="mibItemId" value="${item.id}">
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="form-group required col-xl-2 col-sm-12 col-12">
                                                                                                        <div class="mb-3">
                                                                                                            ...
                                                                                                            <div class="input input-group">
                                                                                                                <input type="text" class="form-control" id="labelStatus" name="labelStatus" value="${testResult.manualStatus}" readonly>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <!--                                                                                            <div class="col-sm-6">
        ...
        <div class="offcanvas-placeholder">
            ...
            <div class="offcanvas offcanvas-returnHw" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop"
                ...
                <div class="offcanvas-body">
                    <div>
                        <form class="row g-3 align-items-center" role="form" action="${contextPath}/rmsbookingDetail/recallSingle" method="post">
                            <div class="row mb-3">
                                <div class="col-xl-12 col-sm-12 col-12">
                                    <div class="mb-1">
