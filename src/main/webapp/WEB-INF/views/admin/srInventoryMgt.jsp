            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            <h2 class="pull-left">Sample Retention Inventory Management List</h2>
<!--                            <a href="${contextPath}/srInventoryMgt/add/" id = "addInventory" class="btn btn-primary pull-right" title="Add Inventory">
                        ...
                        <div class="table-responsive">
                            <table id="dt_spml" class="table">
                                ...
                                <tbody>
                                    <c:forEach items="${srInvMgtList}" var="inventoryMgt" varStatus="inventoryMgtLoop">
                                        <tr>
                                            <td><c:out value="${inventoryMgtLoop.index+1}"/></td>
                                            <td><c:out value="${inventoryMgt.rackMonth}"/></td>
                                            <td><c:out value="${inventoryMgt.rackId}"/></td>
                                            <td><c:out value="${inventoryMgt.shelfId}"/></td>
                                            <td><c:out value="${inventoryMgt.outerId}"/></td>
                                            ...
                                            <td align="center">
                                                <a href="${contextPath}/srInventoryMgt/edit/${inventoryMgt.id}" id="edit" name="edit" class="table-link" title="Edit">
                                                    <span class="fa-stack">
    ...
    <s:layout-component name="page_js_inline">
        <script>
            ...
            function modalDelete(e) {
                ...
                var deleteUrl = "${contextPath}/admin/srInventoryMgt/delete/" + deleteId;
