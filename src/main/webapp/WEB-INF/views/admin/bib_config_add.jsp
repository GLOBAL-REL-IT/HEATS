            ...
            <div class="row gx-4">
                <div class="col-sm-12 col-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <!-- Row start -->
                            <form class="row g-3 align-items-center" role="form" action="${contextPath}/admin/bibActivity/save" method="post">
                                <div class="row mb-4">
                                    <label class="col-sm-2 col-md-1 col-form-label fw-semibold" for="fName">Item Type</label>
                                    <div class="col-sm-9 col-md-10">
                                        <div class="row g-2">
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="itemType" name="itemType" value="${item.itemType}" disabled>
                                                <input type="hidden" class="form-control" id="mibItemId" name="mibItemId" value="${item.id}">
                                                <input type="hidden" class="form-control" id="sptsPkid" name="sptsPkid" value="${item.sptsPkid}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xl-2 col-sm-12 col-12">
                                        <div class="row g-1">
                                            ...
                                            <div class="input-group form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch" id="viCheck" name="viCheck" >
                                            </div>
                                            ...
                                            <div class="input-group form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch" onchange="toggleVisibility()" id="manualTestCheck" name="manualTestCheck" >
                                            </div>
                                            ...
                                            <div class="input-group form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch" id="daqTestCheck" name="daqTestCheck" >
                                            </div>
