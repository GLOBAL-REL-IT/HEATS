                ...
                <div class="col-sm-12 col-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title">Hardware Module - Update SPTS data into HEATS DB</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 align-items-center" role="form" action="${contextPath}/hw/hardware" method="post">
                                <div class="col-xl-4 col-sm-12 col-12">
                                    <div class="mb-3">
                                        <label for="count" class="form-label">Total SPTS Data</label>
                                ...
                                <div class="col-xl-4 col-sm-12 col-12">
                                    <div class="mb-3">
                                        <label for="countAdd" class="form-label">Total Insert into DB</label>
                                        <div class="input-group">
                                            <!--<span class="input-group-text"><i class="bi bi-envelope"></i></span>-->
