...
<s:layout-render name="/WEB-INF/base/base.jsp">
    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <h1>Add Event Group</h1>
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-box">
                        <h2>Event Group Information</h2>
                        <form id="add_group_form" class="form-horizontal" role="form" action="${contextPath}/admin/eventGroup/save" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="groupDetails" name="groupDetails" placeholder="Details" value="${name}">
                                </div>
                            </div>
                            <div class="form-group">
