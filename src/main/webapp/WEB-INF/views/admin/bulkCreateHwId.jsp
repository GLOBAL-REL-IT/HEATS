                ...
                <div class="col-sm-12 col-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title">Hardware Module - Create Hardware ID in Bulk</h5>
                        </div>

                        <div class="card-body">

                            <!-- Row start -->
                            <form class="row g-3 align-items-center" role="form" action="${contextPath}/hw/test123" method="post">
                                <div class="col-xl-4 col-sm-12 col-12">
                                    <div class="mb-3">
                                        <label for="count" class="form-label">Total BIB</label>
                                        <div class="input-group">
                                            <!--<span class="input-group-text"><i class="bi bi-envelope"></i></span>-->
                                            <input type="text" class="form-control" id="count" name="count" placeholder="" value="${count}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-sm-12 col-12">
                                    <div class="mb-3">
                                        <label for="countAdd" class="form-label">Total New Hardware ID</label>
                                        <div class="input-group">
                                            <!--<span class="input-group-text"><i class="bi bi-envelope"></i></span>-->
                                            <input type="text" class="form-control" id="countAdd" name="countAdd" placeholder="" value="${countAdd}">
                                        </div>
                                    </div>
                                </div>
                            </form>
