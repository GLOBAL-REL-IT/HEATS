        ...
        <div class="content-wrapper">
            ...
            <div class="row gx-4">
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="m-0" style="color:#AA2B1D">Hi, ${sessionScope.userSession.fullname}.<br><br>
                                <c:if test="${sessionScope.userSession.requestAccess == 'No'}">
                                    You currently do not have the required privileges to access this web application. Please click the <b>'Request Access'</b> button to send a request to the system administration team.<br><br>
                                    Thank you. </h5><br><br>
                                <a modaldeleteid="${sessionScope.userSession.loginId}" href="#" class="btn btn-outline-success" role="button" data-bs-toggle="modal" data-bs-target="#confirmation_modal" onclick="modalDelete(this);">
                                    <i class='bi bi-door-open'></i>&nbsp;&nbsp;Request Access</a>
                                </c:if>
                                <c:if test="${sessionScope.userSession.requestAccess == 'Yes'}">
                                Your access request has been successfully submitted. Pls allow some time for the system administration team to process and register your account. <br><br>
                                Thank you. </h5><br><br>
                                <a href="#" class="btn btn-outline-warning disabled" role="button" >
                                    <i class='bi bi-door-open'></i>&nbsp;&nbsp;Access Requested</a>
                                </c:if>
    ...
    <s:layout-component name="page_js_inline">
        <script>
                                    ...
                                    function modalDelete(e) {
                                        var loginId = $(e).attr("modaldeleteid");
                                        var deleteUrl = "${contextPath}/sentAccessRequest/" + loginId;
                                        var deleteMsg = "Pls click 'Confirm' button to request user access. Email will be send to system administration for account registration process.";
