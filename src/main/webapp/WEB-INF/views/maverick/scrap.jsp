<%-- 
    Document   : scrap
    Created on : Sep 23, 2026, 3:39:26 PM
    Author     : zbqb9x
--%>
            ...
            <div class="col-12">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title">New SINI PAGE SCRAP KITA Test <span class="h6" style="color:red">(${countItemPending})</span> 
                            <a type="button" data-bs-toggle="offcanvas" title="Summary" data-bs-target="#staticBackdropSummary" aria-controls="staticBackdropSummary">
