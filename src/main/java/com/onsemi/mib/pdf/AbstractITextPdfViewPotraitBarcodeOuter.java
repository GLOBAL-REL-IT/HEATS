...
public abstract class AbstractITextPdfViewPotraitBarcodeOuter extends AbstractView {

    public AbstractITextPdfViewPotraitBarcodeOuter() {
...
//        Rectangle one = new Rectangle(320, 200);
        Rectangle one = new Rectangle(330, 200);
