                    ...
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            ...
                            <div class="filter-block pull-right">
                                <a href="${contextPath}/sr/noRetention/query" class="btn btn-primary pull-right">
                                    <!--<a href="${contextPath}/sr/retrieve/add" class="btn btn-primary pull-right">-->
                                    <i class="bi bi-search h4"></i> Query
                                </a>
                            </div>
                        </div>
                        <hr/>
                            ...
                            <table id="dt_spml" class="display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th align = "center">Cancel By</th>
                                        <th align = "center">Cancel Date</th>
                                        <th align = "center">Manage</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <c:forEach items="${srArchiveList}" var="ftpdata" varStatus="ftpListLoop">
                                        <tr>                                            
                                            <td><c:out value="${ftpListLoop.index+1}"/></td>
                                            <td><c:out value="${ftpdata.rmsId}"/></td>
                                            <td><c:out value="${ftpdata.rmsEvent}"/></td>
                                            ...
                                            <td><c:out value="${ftpdata.compDate}"/></td>
                                            <td><c:out value="${ftpdata.pStatus}"/></td>
                                            <td><c:out value="${ftpdata.cancelBy}"/></td>
                                            <td align="center"><c:out value="${ftpdata.cancelDate}"/></td>
                                            <td align="center">    
                                                <a modaldeleteid="${ftpdata.id}" title="Revert Cancellation" data-toggle="modal" href="#confirmation_modal" class="table-link danger group_delete" onclick="modalRevert(this);">
                                                    <i style = "color:green;" class="bi bi-arrow-clockwise h3"></i>
                                                </a>
                                                    <a modaldeleteid="${ftpdata.id}" title="Delete" data-toggle="modal" href="#confirmation_modal" class="table-link danger group_delete" onclick="modalDelete(this);">
                                                    <i style = "color:red;" class="bi bi-trash3-fill h3"></i>
                                                </a>
                                            </td>
                                        </tr>
                                    </c:forEach>
...
<s:layout-component name="page_js_inline">
    <script>
                                                    ...
                                                    function modalRevert(e) {
                                                        var deleteId = $(e).attr("modaldeleteid");
                                                        var deleteInfo = $("#modal_delete_info_" + deleteId).html();
                                                        var deleteUrl = "${contextPath}/sr/noRetention/revertCancel/" + deleteId;
//                                                        var deleteMsg = "<f:message key='general.label.delete.confirmation'><f:param value='" + deleteInfo + "'/></f:message>";
                                                        var deleteMsg = "Are you sure want to revert the cancellation for this RMS sample?";
                                                    ...
                                                    function modalDelete(e) {
                                                        var deleteId = $(e).attr("modaldeleteid");
                                                        var deleteInfo = $("#modal_delete_info_" + deleteId).html();
                                                        var deleteUrl = "${contextPath}/sr/noRetention/delete/" + deleteId;
//                                                        var deleteMsg = "<f:message key='general.label.delete.confirmation'><f:param value='" + deleteInfo + "'/></f:message>";
                                                        var deleteMsg = "Are you sure want to delete this RMS sample?";
                                                        $("#confirmation_modal .modal-body").html(deleteMsg);
                                                        $("#modal_button").attr("href", deleteUrl);
                                                    }
        </script>
