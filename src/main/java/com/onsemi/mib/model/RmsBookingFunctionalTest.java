...
public class RmsBookingFunctionalTest {
    ...
    public String getLeakHwid() {
        return leakHwid;
    }

    public void setLeakHwid(String leakHwid) {
        this.leakHwid = leakHwid;
    }

    public String getLeakQty() {
        return leakQty;
    }

    public void setLeakQty(String leakQty) {
        this.leakQty = leakQty;
    }

    public String getLeakUpload() {
        return leakUpload;
    }

    public void setLeakUpload(String leakUpload) {
        this.leakUpload = leakUpload;
    }
    ...
    public String getManualQty() {
        return manualQty;
    }

    public void setManualQty(String manualQty) {
    ...
    public String getBibHwid() {
        return bibHwid;
    }

    public void setBibHwid(String bibHwid) {
        this.bibHwid = bibHwid;
    }

    public String getBibQty() {
        return bibQty;
    }

    public void setBibQty(String bibQty) {
        this.bibQty = bibQty;
    }

    public String getBibUpload() {
        return bibUpload;
    }
    ...
    public void setPsHwid(String psHwid) {
        this.psHwid = psHwid;
    }
    ...
    public String getWinHwid() {
        return winHwid;
    }

    public void setWinHwid(String winHwid) {
        this.winHwid = winHwid;
    }
    ...
    public void setWinQty(String winQty) {
        this.winQty = winQty;
    }

    public String getWinUpload() {
        return winUpload;
    }

    public void setWinUpload(String winUpload) {
        this.winUpload = winUpload;
    }
