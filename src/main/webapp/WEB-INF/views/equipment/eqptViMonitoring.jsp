                ...
                <div class="col-sm-12 col-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title">Eqpt VI Monitoring - <span style="color:#D97D55">New Eqpt VI Monitoring Registration</span></h5>
                        </div>

                        <div class="card-body">
                            <!-- Row start -->
                            <form class="row g-3 align-items-center needs-validation" role="form" action="${contextPath}/equipment/viMonitoring/save" method="post" novalidate>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-md-2 col-form-label fw-semibold" for="singleSelect">VI Monitoring Name</label>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="row g-2">
                                            <div class="col-sm-12">
                                                <c:if test="${userEqptViMonAdd == 'Yes'}">
                                                    <input type="text" class="form-control" id="viMonitoring" name="viMonitoring" placeholder="Name" value="" required>
                                                </c:if>
                                                <c:if test="${userEqptViMonAdd != 'Yes'}">
                                                    <input type="text" class="form-control" id="viMonitoring" name="viMonitoring" placeholder="Name" value="" disabled>
                                                </c:if>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="customButtons1" class="table custom-table pending">
                                            ...
                                            <tbody>
                                                <c:forEach items="${eqptViMonitoring}" var="parameterMaster" varStatus="parameterMasterLoop">
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <c:if test="${userEqptViMonDelete == 'Yes'}">
...
<s:layout-component name="page_js_inline">
    <script>
                                                    ...
                                                    function modalDelete(e) {
                                                        ...
                                                        var deleteUrl = "${contextPath}/equipment/viMonitoring/delete/" + deleteId;
