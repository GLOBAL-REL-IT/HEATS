...
public class MIBGatewayRequestTest {
...
//        }
//        System.out.println("COUNT GET ITEM BY PARAM..." + getItemByParam.length());
//        System.out.println("GET Eqpt Booked FOL Files...");
//        JSONArray getEqptBookedFOLFiles = SPTSWebService.getBookedEqptFOLFiles(Boolean.FALSE);
//        for (int i = 0; i < getEqptBookedFOLFiles.length(); i++) {
//            System.out.println(getEqptBookedFOLFiles.getJSONObject(i));
//        }
//        System.out.println("COUNT Eqpt Booked FOL Files..." + getEqptBookedFOLFiles.length());
//        System.out.println("GET Eqpt Booked FOL Files by pkid...");
//        JSONArray getEqptBookedFOLFilesByPkid = SPTSWebService.getBookingByPKID(56967);
//        for (int i = 0; i < getEqptBookedFOLFilesByPkid.length(); i++) {
...
//        params.put("pkID", "68788");
//        JSONArray getBookedEquipment2 = SPTSWebService.getItemByParam(params);
//        for (int i = 0; i < getBookedEquipment2.length(); i++) {
//            System.out.println(getBookedEquipment2.getJSONObject(i));
//        }
//        JSONObject getItemAll = MIBGatewayWebService.getCBMSGetBookingDetailsByBookingPKID("5683");
//        System.out.println(getItemAll.getJSONObject());

        JSONObject params = new JSONObject();
        params.put("rmsNo", "S100048");
        params.put("eventNameCode", "HTOL");
        JSONArray getCbmsBooking = MIBGatewayWebService.getCBMSGetBookingDetailsByRMSNoAndEventNameCode(params);
        for (int i = 0; i < getCbmsBooking.length(); i++) {
            System.out.println(getCbmsBooking.getJSONObject(i));
        }
//                  System.out.println(getItemAll.toString());
...
//        DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
        //get current date time with Date()
//        Date date = new Date();
//        String date = "2023-07-04T15:07:35.205";
//        String formattedDate = dateFormat.format(date);
//        String date1 = formattedDate.substring(0, 10);
//        String time = formattedDate.substring(11, 23);
//        String completeDateTime = date1 + "T" + time;
//        String completeDateTime = "2023-07-04T15:07:35.205";
//        params2.put("dateTime", completeDateTime);
//        params2.put("itemsPKID", itempkid);
//        params2.put("transType", "19");
//        params2.put("transQty", "1");
...
//        }
//        JSONObject jsonObject2 = SPTSWebService.getItemByPKID("6187");
//                System.out.println(jsonObject2.toString());
//        int itemSfApkid = getItemByParamA.getJSONObject(0).getInt("PKID");
//        String versionSfA = getItemByParamA.getJSONObject(0).getString("Version");
