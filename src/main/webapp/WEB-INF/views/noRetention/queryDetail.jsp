            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            <h2 class="pull-left">Data Logs for : ${rmsLotEvent}</h2>

                            <div class="col-lg-12">
                                <a href="${contextPath}/sr/noRetention/query" class="btn btn-info pull-left"><i class="fa fa-reply"></i> Back</a>
                            </div>
                        </div>
                        <hr/>
                        <div class="clearfix">
                            ...
                            <table id="dt_spml" class="display" cellspacing="0" width="100%">
                                ...
                                <c:forEach items="${log}" var="doList" varStatus="ftpListLoop">
                                    <tr>
                                        ...
                                        <!--<td><c:out value="${doList.ftpId}"/></td>-->
