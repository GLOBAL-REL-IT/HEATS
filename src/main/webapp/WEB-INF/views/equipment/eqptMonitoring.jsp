                ...
                <div class="col-sm-12 col-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title">Eqpt Monitoring - <span style="color:#D97D55">New Eqpt Monitoring Registration</span></h5>
                        </div>

                        <div class="card-body">
                            <!-- Row start -->
                            <form class="row g-3 align-items-center needs-validation" role="form" action="${contextPath}/equipment/monitoring/save" method="post" novalidate>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-md-2 col-form-label fw-semibold" for="singleSelect">Monitoring Name</label>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="customButtons1" class="table custom-table pending">
                                            ...
                                            <tbody>
                                                <c:forEach items="${eqptMonitoring}" var="parameterMaster" varStatus="parameterMasterLoop">
                                                    <tr>
...
//                                                                info: "Showing Page _PAGE_ of _PAGES_",
                                                    ...
                                                    function modalDelete(e) {
                                                        ...
                                                        var deleteUrl = "${contextPath}/equipment/monitoring/delete/" + deleteId;
