...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>STORMS - Register</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="Sendayan Storage and Retention Management System (STORMS)">
        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <center style="margin-top: 30px;"><a href="${contextPath}/" style="font-family: 'Lato'; font-size: 22px;">Sendayan Storage and Retention Management System (STORMS)</a></center>
                </div>
            </div>
        </div>
                ...
                <div class="span6">
                    <div id="register-wraper">
                        <form id="register-form" action="${contextPath}/register" method="post"  class="form">
                            ...
                            <legend>Register to <span class="blue">STORMS</span></legend>
