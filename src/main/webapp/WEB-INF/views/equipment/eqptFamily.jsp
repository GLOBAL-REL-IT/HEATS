                ...
                <div class="col-sm-12 col-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title">Eqpt Family - <span style="color:#D97D55">New Eqpt Family Registration</span></h5>
                        </div>

                        <div class="card-body">
                            <!-- Row start -->
                            <form class="row g-3 align-items-center needs-validation" role="form" action="${contextPath}/equipment/family/save" method="post" novalidate>
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-md-2 col-form-label fw-semibold" for="singleSelect">Family Name</label>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="row g-2">
                                            <div class="col-sm-12">
                                                <c:if test="${userEqptFamilyAdd == 'Yes'}">
                                                    <input type="text" class="form-control" id="familyName" name="familyName" placeholder="Name" value="" required>
                                                </c:if>
                                                <c:if test="${userEqptFamilyAdd != 'Yes'}">
                                                    <input type="text" class="form-control" id="familyName" name="familyName" placeholder="Name" value="" disabled>
                                                </c:if>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="customButtons1" class="table custom-table pending">
                                            ...
                                            <tbody>
                                                <c:forEach items="${eqptFamily}" var="parameterMaster" varStatus="parameterMasterLoop">
                                                    <tr>
                                                        <td><c:out value="${parameterMasterLoop.index+1}"/></td>
                                                        <td id="modal_delete_info_${parameterMaster.id}"><c:out value="${parameterMaster.familyName}"/></td>
                                                        ...
                                                        <td align="center">
                                                            <c:if test="${parameterMaster.inGlobalOrNot == 'No'}">
                                                                <c:if test="${userEqptFamilyAddGlobal == 'Yes'}">
                                                                    <a modaldeleteid="${parameterMaster.id}" familyName="${parameterMaster.familyName}" title="Add to Global" data-bs-toggle="modal" data-bs-target="#confirmation_modal" class="table-link danger group_delete" onclick="modalAddGlobal(this);">
                                                            ...
                                                            <c:if test="${userEqptFamilyDelete == 'Yes'}">
...
<s:layout-component name="page_js_inline">
    <script>
                                                                    ...
                                                                    function modalDelete(e) {
                                                                        ...
                                                                        var deleteUrl = "${contextPath}/equipment/family/delete/" + deleteId;
                                                                    ...
                                                                    function modalAddGlobal(e) {
                                                                        ...
                                                                        var deleteUrl = "${contextPath}/equipment/family/insertGlobal/" + familyId;
