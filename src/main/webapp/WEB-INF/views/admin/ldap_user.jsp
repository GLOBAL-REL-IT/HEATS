                    ...
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            ...
                            <div class="filter-block pull-right">
                                <c:if test="${testEmailAccess=='Active'}">
                                    <a href="${contextPath}/admin/testEmail" class="btn btn-primary pull-right">
                                        <i class="fa fa-mail-bulk fa-lg"></i> Test Email
                                    </a>
                                </c:if>
                            </div>
                            <div class="filter-block pull-right">
                                    ...
                                    <c:forEach items="${userList}" var="user" varStatus="userLoop">
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="${contextPath}/admin/ldap_user/edit/${user.id}" class="table-link">
                                                    <span class="fa-stack">
                                                        <i class="fa fa-square fa-stack-2x"></i>
