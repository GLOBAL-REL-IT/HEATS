...
<s:layout-definition>
    ...
    <html>
        <head>
            ...
            <link href="${contextPath}/resources/private/css/libs/all.css" type="text/css" rel="stylesheet" />
            ...
            <header class="navbar" id="header-navbar">
                <div class="container">
                    <a href="${contextPath}/" id="logo" class="navbar-brand col-md-6 col-sm-6 col-xs-12">
                        <span>OSPI Storage and Retention Management System (OSTORMS)</span>
                    </a>
                        ...
                        <ul class="nav navbar-nav pull-right">
                            <li class="dropdown profile-dropdown">
                                ...
                                <!--<a href="#" class="dropdown-toggle" data-toggle="dropdown">-->
                                    ...
                                    <span class="hidden-xs">${sessionScope.userSession.fullname}</span>
                                </a>
<!--                                <ul class="dropdown-menu">
            ...
            <footer id="footer-bar">
                <p id="footer-copyright">
                    Copyright &copy; 2025, <a href="http://onsemi.com/" target="_blank">ON Semiconductor</a>.
                    | <a href="javascript:AlertInfo();">Info </a> | <a href="javascript:AlertContact();">Contact </a>
                </p>
            </footer>
            <!-- Modal -->
