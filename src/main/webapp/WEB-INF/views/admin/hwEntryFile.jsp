    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <div class="row">
                <div class="col-lg-11">
                    <div class="main-box">
                        <h2>Upload File to Create HW Barcode</h2>
                        <form id="upload_hwbarcode_file_frm" class="form-horizontal" role="form" action="${contextPath}/admin/hwEntryFile/upload" method="post"  enctype="multipart/form-data">
                            <div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                ...
                                <b><i>Mandatory Requirement</i> >> File Type :</b> .csv || <b>Date Format :</b> yyyy-mm-dd hh:mm:ss || <b>Column :</b> box_id,equipment_type,equipment_id,quantity,request_date 
                            </div>
                            ...
                            <div class="pull-right">
                                ...
                                <button type="submit" class="btn btn-primary"><i class="fa fa-barcode fa-lg"></i> Create Barcode</button>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-11">
                    <div class="main-box">
                        <h2>Upload File to Generate HW Shipping List</h2>
                        <form id="upload_hwship_file_frm" class="form-horizontal" role="form" action="${contextPath}/admin/hwShipFile/upload" method="post"  enctype="multipart/form-data">
                            <div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                <!--<span class="fa-stack"><i class="fa fa-exclamation-triangle fa-stack-2x" style="color:red"></i></span>-->
                                <b><i>Mandatory Requirement</i> >> File Type :</b> .csv || <b>Date Format :</b> yyyy-mm-dd hh:mm:ss || <b>Record Limit :</b> Per GTS No. || 
                                <p><b>Column :</b> gts_no, ship_date, box_id, item_type, item_id, weight, price, total_weight, total_price
    ...
    <s:layout-component name="page_js_inline">
        <script>
            $(document).ready(function () {
                ...
                var validator2 = $("#upload_hwship_file_frm").validate({
                    rules: {
                        fileShipUpload: {
                            required: true
                        }
