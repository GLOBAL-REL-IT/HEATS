                    ...
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            ...
                            <div class="filter-block pull-right">
                                <c:if test="${count == 0}">
                                    <a href="${contextPath}/sr/srShipping/doList" class="btn btn-primary pull-right" id="viewDoList" disabled>
                                        <i class="fa fa-list fa-lg"> </i> View DO List
                                    </a>
                                </c:if>
                                <c:if test="${count != 0}">
                                    <a href="${contextPath}/sr/srShipping/doList" class="btn btn-primary pull-right" id="viewDoList">
                                        <i class="fa fa-list fa-lg"> </i> View DO List
                                    </a>
                                </c:if>
                                <c:if test="${trackGtsAccess=='Active'}">
                                    <a href="${contextPath}/sr/srShipping/trackGts" class="btn btn-success pull-right" id="viewDoList">
                                        <i class="fa fa-search fa-lg"> </i> Track GTS Number
                                    </a>
                                </c:if>
