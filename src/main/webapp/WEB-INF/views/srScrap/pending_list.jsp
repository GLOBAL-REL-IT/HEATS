<%-- 
    Document   : pending_list
    Created on : Jan 7, 2025, 11:47:36 AM
    Author     : zbqb9x
--%>
...
<s:layout-render name="/WEB-INF/base/base.jsp">
    ...
    <s:layout-component name="page_container">
        <div class="col-lg-12">
            <!--<h1>SR Management - Scrap Pending List</h1>-->
            <div class="row">
                <div class="col-lg-12">
                    <div class="main-box clearfix">
                        <div class="clearfix">
                            <h2 class="pull-left">Scrap Pending List</h2>
                            <div class="filter-block pull-right">
                                <a href="${contextPath}/sr/scrap/register_scrap" class="btn btn-primary pull-right">
                                    <i class='bx bx-list-plus bx-fw' style='color:#ffffff' ></i>Create Scrap List
                                </a>
                            </div>
                        </div>
                        <hr/>
                        ...
                        <div class="table-responsive">
                            <table id="dt_spml" class="display" cellspacing="0" width="100%">
                                ...
                                <thead>
                                    <tr>
                                        <th><span>No</span></th>
                                        <th><span>Scrap Month</span></th>
                                        <th><span>Inventory</span></th>
                                        <th><span>RMS Lot Event</span></th>
                                        <th><span>Package Name</span></th>
                                        <th><span>Status</span></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <c:forEach items="${srScrapList}" var="whRequest" varStatus="whRequestLoop">
                                        <tr>
                                            <td><c:out value="${whRequestLoop.index+1}"/></td>
                                            <td><c:out value="${whRequest.monthScrap}"/></td>
                                            <td><c:out value="${whRequest.shelf}"/></td>
                                            <td><c:out value="${whRequest.rmsLotEvent}"/></td>
                                            <td><c:out value="${whRequest.packageName}"/></td>
